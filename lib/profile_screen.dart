            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 15),
                  profileItem('Name', 'Jerome', CupertinoIcons.person),
                  SizedBox(height: 10),
                  profileItem('Phone', '09123456789', CupertinoIcons.phone),
                  SizedBox(height: 10),
                  profileItem('Address', 'Alangilan, Batangas City', CupertinoIcons.location),
                  SizedBox(height: 10),
                  profileItem('Email', 'jerome11@gmail.com', CupertinoIcons.mail),
                  SizedBox(height: 20),
                  SizedBox(
